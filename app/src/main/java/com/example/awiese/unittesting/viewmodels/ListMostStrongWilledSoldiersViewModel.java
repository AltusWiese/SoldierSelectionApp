...
public class ListMostStrongWilledSoldiersViewModel extends AndroidViewModel {

    private SoldierDao soldierDao;
    private SoldierRepository soldierRepository;
    private LiveData<List<SoldierUnitModel>> listOfSoldiers;

    public ListMostStrongWilledSoldiersViewModel(Application application, SoldierRepository soldierRepository) {
        super(application);
    ...
    public LiveData<List<SoldierUnitModel>> getListOfMostStrongWilledSoldiers() {
        ...
        listOfSoldiers = soldierRepository.listMostStrongWilledSoldiers();
       // listOfSoldiers = soldierDao.getMostStrongWilledSoldiers(will);
